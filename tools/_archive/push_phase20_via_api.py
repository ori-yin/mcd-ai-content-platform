# -*- coding: utf-8 -*-
r"""push_phase20_via_api.py — Contents API 推 Phase 20（更新已存在文件自动拿 sha）。"""
...
COMMIT_MSG = "Phase 20: l1_model mode 主流程接入 + L1 漂移监控（业务主动切 + 1.3x 告警）"
...
def api_get_sha(path: str) -> str | None:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "claude-phase20-push",
        },
    )
    try:
