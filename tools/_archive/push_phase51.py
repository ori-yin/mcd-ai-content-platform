# -*- coding: utf-8 -*-
"""push_phase51.py — Phase 51 favicon 紧凑 + title 统一 push"""
...
FILES = [
    "web/static/img/mcdonalds.svg",
    "web/templates/base.html",
    "web/templates/pages/01_内容工坊.html",
    "web/templates/pages/02_内容诊断.html",
    "web/templates/pages/03_内容预测.html",
    "web/templates/pages/04_历史洞察.html",
    "web/templates/pages/05_真实结果回流.html",
    "web/templates/pages/06_settings.html",
    "web/templates/pages/06_settings_login.html",
    "Handoff.md",
]

COMMIT_MSG = (
    "feat(ui): favicon 紧凑化 + 7 路由 title 统一\n\n"
    "favicon SVG (358B -> 379B): viewBox 0 0 270.7 236.4 紧凑包住 path\n"
    "title 7 page html: 去数字前缀 + 去后缀 McD AI 内容平台\n"
    "favicon link bump ?v=20260903fv -> ?v=20260903fv2"
)
...
def api(method, path, body=None):
    ...
    req.add_header("User-Agent", "claude-code-push-phase51")
...
def main():
    ...
    print(f"\n[Phase 51 PUSH OK] {new_commit_sha[:10]}")
