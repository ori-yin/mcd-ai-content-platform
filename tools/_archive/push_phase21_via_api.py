# -*- coding: utf-8 -*-
r"""push_phase21_via_api.py — Contents API 推 Phase 19-21（c0da6de + 3ed6a15 合并推送）。"""
...
# 覆盖 c0da6de (.gitignore 加 push_*.py rule) + 3ed6a15 (Phase 19-21 全量)
FILES = [
    ".gitignore",
    "CLAUDE.md",
    "Handoff.md",
    "adapters/ctr_predictor_adapter/__init__.py",
    "adapters/ctr_predictor_adapter/l1_predictor.py",  # NEW
    "docs/overview.html",  # NEW
    "pages/00_home.py",
    ...
    "tests/verify.py",
    "tools/monitor_l1_drift.py",  # NEW
]

COMMIT_MSG = "Phase 19-21: L1 主流程接入 + 漂移监控 + simplify 清理"
...
def api_get_sha(path: str) -> str | None:
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "claude-phase21-push",
        },
    )
    try:
