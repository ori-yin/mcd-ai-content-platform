# -*- coding: utf-8 -*-
"""push_phase46_via_api.py — Phase 46 4 BUG 修复 + 3 Tab 增强推送（Git Data API · 单 commit）
...
用法：
    python tools/push_phase46_via_api.py --token ghp_xxx
"""
...
# 要推的 commits（从旧到新）
COMMITS_TO_PUSH = ["6e7533c", "4e2bc39"]
...
def api(method: str, path: str, body=None):
    ...
    req.add_header("User-Agent", "claude-code-phase46-push")
